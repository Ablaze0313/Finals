        ...
        if($dbError){
          ...
          if(!$unique){
            $_SESSION['signup-error'] = "Username already taken";
              ...
              $insertUserQuery = 'INSERT INTO users (email, password, username, firstname, middlename, lastname)
                values (?,?,?,?,?,?)';
              $stmt = $db->prepare($insertUserQuery);
              $stmt->bind_param("ssssss", $email, $pword, $uname, $fname, $mname, $lname);
              $stmt->execute();
        ...
        if($dbError){
          ...
          if(!$unique){
            $_SESSION['signup-error'] = "Username already taken";
              ...
              $insertUserQuery = 'INSERT INTO users (email, password, username, firstname, lastname, suffix)
                values (?,?,?,?,?,?)';
              $stmt = $db->prepare($insertUserQuery);
              $stmt->bind_param("ssssss", $email, $pword, $uname, $fname, $lname, $suffix);
              $stmt->execute();
        ...
        if($dbError){
          ...
          if(!$unique){
            $_SESSION['signup-error'] = "Username already taken";
              ...
              $insertUserQuery = 'INSERT INTO users (email, password, username, firstname, lastname)
                values (?,?,?,?,?)';
              $stmt = $db->prepare($insertUserQuery);
              $stmt->bind_param("sssss", $email, $pword, $uname, $fname, $lname);
              $stmt->execute();
