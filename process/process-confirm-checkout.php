          ...
          if($cnt > 0){
            ...
            if($cartCnt > 0){
              ...
              for($ite=0; $ite < $cartCnt; $ite++){
                ...
                $selectProducts =
                'SELECT img_dir, name, prices.price
                  FROM products
                    INNER JOIN prices
              ...
              echo '
                <div class="totalCheckout">
                  <h6 class="checkoutTotal" style="color:white;">Total: PhP '.$totalCart.'.00</h6>
                </div>
              ';
      ...
      @ $db = new mysqli('127.0.0.1:3306','FrancisParrenas', 'cutesieya1010', 'webprog_finals');
        ...
        if($dbError){
          ...
          if($_SESSION['paymentMethod'] == 'cod'){
            echo '<h3 class="mt-2 mb-3" style="color:white;">Cash on Delivery</h3><hr class="style">';
          } else {
            echo '<h3 class="mt-2 mb-3" style="color:white;">Credit Card</h3>';
            echo '<h5 style="color:white;">CC Number: <input class="uneditable" value="'.$_SESSION['ccno'].'" readonly></h5>';
            echo '<h5 style="color:white;">Expiry Date: <input class="uneditable" value="'.$_SESSION['expdate'].'"readonly></h5>';
            echo '<h5 style="color:white;">CVV: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input class="uneditable" value="'.$_SESSION['cvv'].'"readonly></h5><hr class="style">';
          }
          ...
          echo '<h3 class="mt-2 mb-3" style="color:white;">Shipping Address</h3>';
          echo '<h5 style="color:white;">House no: <input class="uneditable" value="'.$userAddress['house_number'].'"readonly></h5>';
          echo '<h5 style="color:white;">Street: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input class="uneditable" value="'.$userAddress['street'].'"readonly></h5>';
          echo '<h5 style="color:white;">Barangay:&nbsp<input class="uneditable" value="'.$userAddress['brgy'].'"readonly></h5>';
          echo '<h5 style="color:white;">City: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input class="uneditable" value="'.$userAddress['city'].'"readonly></h5>';
...
function logConfirmCheckout(){
    ...
    $file = @ fopen(DOCUMENT_ROOT.'/Finals/resource/logs.txt', 'ab'); //writing
  ...
  function readLog(){
    ...
    try{
      $file = @ fopen(DOCUMENT_ROOT.'/Finals/resource/logs.txt', 'rb'); // reading
